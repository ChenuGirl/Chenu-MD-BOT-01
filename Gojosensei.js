...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
    ...
    case 'donasi': case 'donate': case 'sewabot': case 'sewa': {
                GojoMdNx.sendMessage(m.chat, { image: { url: 'https://i.ibb.co/zFNLzGr/Chenumi.jpg' }, caption: `*Hi Bro ${m.pushName}*\nContact me via Whatsapp\n` }, { quoted: m })
            }
            break
            case 'sc': case 'script': {
                reply(`Telegram : http://t.me/Rivishan3634\n Tell me this bot Any Bugs\n\nWhatsApp : ${myweb}\nContact Developer`)
            }
            break
case 'allmenu': {
  	anu = `
...
┃╠ ${prefix}report [bug]
┃╚═════════════✪
┗━━「 ${pushname} 」━⭓`,unicorn, [{"urlButton": {"displayText": "♥️Sʅ Dҽҽρ Rҽɱιx♥️","url": `${myweb}`}},{"urlButton": {"displayText": "♥️Rιʋιʂԋαɳ♥️","url": `${sc}`}},{"quickReplyButton": {"displayText": "🍜Contact🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "👤Owner👤","id": 'owner'}}] )
break
...
await GojoMdNx.send5ButImg(from, `` + '' + ' ', `
Thanks to Me ( Rιʋιʂԋαɳ)
Brother (For helping me to deploy qr in replit and answered my every doubts regard this project)
DGXeon ( 45% Credits goes to him ,in this script)
And Again Me (King འìѵì ⱮȺჯ 🎉) 🐦 Who Helped Assemble This Sexy Script !!!`,unicorn, [{"urlButton": {"displayText": "♥️Sʅ Dҽҽρ Rҽɱιx♥️","url": `${myweb}`}},{"urlButton": {"displayText": "♥️Rιʋιʂԋαɳ♥️","url": `${sc}`}},{"quickReplyButton": {"displayText": "🍜Contact🍜","id": 'donate'}},{"quickReplyButton": {"displayText": "👤Owner👤","id": 'owner'}}] )
break
            default:
                if (budy.startsWith('=>')) {
